 ...
 **************************************/
	if ($showlist == "editfield")
	{
		...
		echo '<tr><td class="e">'.ucfirst(_PROFILE_NAME).'</td><td class="v"><input size="40" name="fname" value="'.$row['fname'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_NAME."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_LABEL).'</td><td class="v"><input size="40" name="flabel" value="'.$row['flabel'].'" />'."</td>";
		...
		echo '<input size="40" type="radio" name="required" value="1"'.($row['required'] >= '1' ? ' checked="checked"' : '').' />'._PROFILE_YES.' ';
		echo '<input size="40" type="radio" name="required" value="0"'.($row['required'] == '0' ? ' checked="checked"' : '').' />'._PROFILE_NO.' ';
		echo "</td><td>"._PROFILE_ADMIN_HELP_REQUIRED."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_ENABLED).'</td><td class="v">';
		echo '<input size="40" type="radio" name="enabled" value="1"'.($row['enabled'] >= '1' ? ' checked="checked"' : '').' />'._PROFILE_YES.' ';
		echo '<input size="40" type="radio" name="enabled" value="0"'.($row['enabled'] == '0' ? ' checked="checked"' : '').' />'._PROFILE_NO.' ';
		echo "</td><td>"._PROFILE_ADMIN_HELP_ENABLED."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_LENGTH).'</td><td class="v"><input size="40" name="flength" value="'.$row['flength'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_LENGTH."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_SIZE).'</td><td class="v"><input size="40" name="fsize" value="'.$row['fsize'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_SIZE."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_FORMAT).'</td><td class="v"><input size="40" name="fformat" value="'.$row['fformat'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_FORMAT."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_WIDTH).'</td><td class="v"><input size="40" name="fwidth" value="'.$row['fwidth'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_WIDTH."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_HEIGHT).'</td><td class="v"><input size="40" name="fheight" value="'.$row['fheight'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_HEIGHT."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_FILESIZE).'</td><td class="v"><input size="40" name="ffilesize" value="'.$row['ffilesize'].'" />'."</td>";
		echo "<td>"._PROFILE_ADMIN_HELP_FILESIZE."</td></tr>\n";
		echo '<tr><td class="e">'.ucfirst(_PROFILE_FILETYPES).'</td><td class="v"><input size="40" name="ffiletype" value="'.$row['ffiletype'].'" />'."</td>";
		...
		echo '<input size="40" type="radio" name="fpublic" value="1"'.($row['fpublic'] >= '1' ? ' checked="checked"' : '').' />'._PROFILE_YES.' ';
		echo '<input size="40" type="radio" name="fpublic" value="0"'.($row['fpublic'] == '0' ? ' checked="checked"' : '').' />'._PROFILE_NO.' ';
