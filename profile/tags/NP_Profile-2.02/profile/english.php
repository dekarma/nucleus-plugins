...
define('_PROFILE_ADMIN_HELP_OPTIONS',		'String list. Options for dropdown and radio types. Use format \'display1|value1;display2|value2\' where display is what user sees and value is what gets stored. Can be the same. e.g. \'yes|1;no|0\' displays yes and no to user, but stores 1 or 0 respectively. \'yes|yes;no|no\' displays and stores the values yes or no.');
