...
define('MF_NEW_TEMPLATE',				'New template');
define('MF_COPY',						'Copy');
define('MF_EDIT_TEMPL',					'Edit');
define('MF_DEFAULT_TEMPLATE',			'template with default values');
...
//admin
define('MF_DOCLINK',				'Documentation');
define('MF_FORUMLINK',				'Support');

//******************************************************************************
// Since 0.7.0
//******************************************************************************
//error
define('MF_UGLY_SPAM',				'SPAM! It looks like you are spambot!');
define('MF_NOFOLLOW',				'Add rel="nofollow" to links.');

//admin
define('MF_MISSING_POST_BODY_OR_NAME', 	"User name and post body must be specified.");
define('MF_OPTIONSLINK', 			"Options");
define('MF_FORUMS', 			    "Forums");
define('MF_OPTIONSLINK_TITLE', 		"Plugin options");
define('MF_FORUMS_TITLE', 			"Forum management");
define('MF_DOCLINK_TITLE',			'documentation - on Nucleus CMS wiki');
define('MF_FORUMLINK_TITLE',		'NP_MiniForum thread in Nucleus CMS forum');
define('MF_TEMPLATES_TITLE',		'Templates management');
define('MF_EMPTY_TEMPLATE',			'empty template');
define('MF_TEMPLATES_LIST',			'Templates');
define('MF_SAVE_FORUM_BUTTON',		'sava forum');
define('MF_BACK_TO_FORUMADMIN',		'back to forum administration');
define('MF_BACK_TO_POSTADMIN',		'back to list of posts');
define('MF_TEMPLATE_DELETED',		'Template deleted.');
define('MF_TEMPLATE_OPTIONS',		'Template settings');
define('MF_TEMPLATE_PARTS',			'Template parts');
define('MF_FORUM_SAVED', 			'Forum saved.');
