...
<!-- image properties -->
	<table class="inputTable">
		<tr>
			...
			<td rowspan="3" align="right">&nbsp;</td>
			<td align="right" class="off"><label for="f_vert">V Space</label></td>
			<td class="off"><input type="text" id="f_vert" class="smallWidth" value="" /></td>
		</tr>		
		<tr>
			...
			<td align="right" class="off"><label for="f_horiz">H Space</label></td>
			<td class="off"><input type="text" id="f_horiz" class="smallWidth" value="" /></td>
		</tr>
		<tr>
...
<? } else { ?>
			<td colspan="2"></td>
<? } ?>
			<td align="right" class="off"><label for="f_align">Align</label></td>
			...
			<td align="right" class="off"><label for="f_border">Border</label></td>
			<td class="off"><input type="text" id="f_border" class="smallWidth" value="" /></td>
		</tr>
		<tr> 
