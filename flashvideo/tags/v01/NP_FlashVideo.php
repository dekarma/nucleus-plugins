...
class NP_FlashVideo extends NucleusPlugin {
    ...
    function flvCode($param) {
       ...
       $code= '<object type="application/x-shockwave-flash" width="'.$this->getOption('width').'" height="'.$this->getOption('height').'" data="media/flvplayer.swf?file='.$fileurl.$autostart.'"><param name="movie" value="media/flvplayer.swf?file='.$fileurl.$autostart.'" /><param name="wmode" value="transparent" /></object>';
