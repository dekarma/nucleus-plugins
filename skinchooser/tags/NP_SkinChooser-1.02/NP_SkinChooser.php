...
/* This plugin allows Nucleus CMS users to make their
  * sites available in user-selected skins.
  */
...
/*
    ...
    * v 1.02 - 3rd release
      * fix XHTML 1.0 compliance issue
      * fix copy-paste error in plugin description comments
*/
