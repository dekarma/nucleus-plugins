...
<p>Use this bookmark to add a link to your blogroll: <a href="javascript:location.href='<? echo $oPluginAdmin->plugin->getAdminURL(); ?>bookmarklet.php?action=bmaddlink&url='+encodeURIComponent(location.href)+'&text='+encodeURIComponent(document.title)">Blogroll it!</a></p>
<?
  $oPluginAdmin->end();
}
else {
  ...
  $text = $_POST['text'] == "" ? stripslashes($_GET['text']) : stripslashes($_POST['text']);
  $desc = $_POST['desc'] == "" ? stripslashes($_GET['desc']) : stripslashes($_POST['desc']);
