		...
		switch ($tag) {
			...
			case 'LINK':
				if ($attributes['REL'] == 'alternate') {
					$this->currentItem['link'] = $attributes['HREF'];
				}
				break;
		}
	}	
...
/*
$gcal = new GoogleCalendar("http://www.google.com/calendar/feeds/toastyou@gmail.com/public/basic");
//$gcal = new GoogleCalendar("/home/ketsugi/gcal.xml");
